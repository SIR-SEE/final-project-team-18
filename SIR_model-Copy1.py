...
N =  10000000 #Totala befolkningen N=s(t)+I(t)+R(t)
D = 7 #Hur länge infektionen varar
gamma = 2 / D #Removal (hur många som tillfrisknar per dag)
...
S0, E0, I0, R0, B0 = N-1, 1, 0, 0, 0  # initial conditions: one infected, rest susceptible
#Rt = R0 * S(t)/Ntot* (1 – b). b = effekt av policy och beteendeförändringar



t = np.linspace(0, 999, 1000) # Grid of time points (in days)
y0 = S0, E0, I0, R0, B0 # Initial conditions vector
